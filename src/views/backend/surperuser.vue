<template>
  <div class="userinfo mx-auto">
    <Navbar>
      <template #default>管理中心</template>
    </Navbar>
    <div class="user-box mx-auto">
      ...
      <ul class="user-list col-12 col-md-10 mx-auto">
        <li class="" @click="goTo('/getCartList')">
          <span>管理商品</span>
          <i class="fas fa-chevron-right"></i>
        </li>
        <li class="" @click="goTo('/addcart')">
          <span>新增商品</span>
          <i class="fas fa-chevron-right"></i>
        </li>
        <li class="" @click="goTo('/getUserList')">
          <span>會員管理</span>
          <i class="fas fa-chevron-right"></i> 
        </li>
        <li class="" @click="goTo('/addUser')">
          <span>新增會員</span>
          <i class="fas fa-chevron-right"></i>
        </li> 
      </ul>
    ...
    <div class="btn col-8 col-md-6 mt-5" style="">
      <van-button class="col-md-6 mx-auto" @click="toLogout" color="#42b983" round block>
        登出
      </van-button>
    </div>
    <div class="wall"></div>
